...
按下「刷新並顯示」後，程式會在桌面右下角顯示一個永遠置頂、可拖曳的透明角色小工具。泡泡內顯示剩餘與已用 Token；角色使用使用者提供的白紫色 AI 生成龍族 Q 版透明圖，公開候選使用的版本已移除 OpenAI Blossom 樣式髮飾。小工具右上角可重新刷新或隱藏。

桌寵互動已依照 DSH 小鯨魚掛件的展示方式調整：
